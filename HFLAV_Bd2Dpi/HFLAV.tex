...
\newcommand{\Sf}{\mbox{\ensuremath{S_{\kern -0.8pt D^{-}\pi^{+}}}}\xspace}
\newcommand{\Sfbar}{\mbox{\ensuremath{S_{\kern -0.8pt D^{+}\pi^{-}}}}\xspace}
\newcommand{\Cf}{\mbox{\ensuremath{C_{\kern -0.8pt D^{-}\pi^{+}}}}\xspace}
\newcommand{\Cfbar}{\mbox{\ensuremath{C_{\kern -0.8pt D^{+}\pi^{-}}}}\xspace}
